...
export function PasswordFields() {
  ...
  return (
    <div ref={ceremonyRef} className="ft-passwordtab" onKeyDown={handleKeyDown}>
      ...
      >
        <label className="ft-passwordtab__label">Change Password</label>
        ...
        {passwordError ? (
          <div className="ft-passwordtab__error">{passwordError}</div>
        ) : (
      ...
      >
        <label className="ft-passwordtab__label">Confirm Password</label>
        <div className="ft-passwordtab__input-wrapper">
          {box2State.isEditing ? (
            <input
              ref={box2InputRef}
        ...
        {confirmError && (
          <div className="ft-passwordtab__error">{confirmError}</div>
        )}
      </div>
    </div>
  );
