/**──────────────────────────────────────────────────────────────────────┐
│  🔐 FORGOT PASSWORD FEATURE - Dirty Clerk Playground                  │
│  /src/features/auth/ForgotPassword/index.tsx                          │
│                                                                        │
│  VR DOCTRINE: Feature Layer                                            │
│  - All Clerk hooks live here                                           │
│  - All state management                                                │
│  - All handlers                                                        │
│  - Uses VRs (Modal.verify, Button.fire)                               │
│                                                                        │
│  The page imports this as ONE LINE.                                    │
│  All the dirty work is confined here.                                  │
└────────────────────────────────────────────────────────────────────────┘ */
...
export function ForgotPassword() {
  ...
  return (
    <>
      {/* Header - Hidden during code stage (Modal.verify owns the UI) */}
      {stage !== "code" && (
        <div className="ft-auth-header">
      ...
      {/* Code Verification Stage - Using Modal.verify VR (inline variant) */}
      <Modal.verify
        variant="inline"
        isOpen={stage === "code"}
        email={email}
