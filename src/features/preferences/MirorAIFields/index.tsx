    ...
    <div className="ft-mirror-ai">
      ...
      >
        {/* Avatar Grid + Preview wrapper */}
          <div className="ft-mirror-ai-avatar-row">
            {/* Avatar Grid */}
            <div className="ft-mirror-ai-avatar-grid">
              {AVATAR_OPTIONS.map((option) => (
                <button
                  key={option}
                  type="button"
                  className={`ft-mirror-ai-avatar-option ${avatarProfile === option ? 'ft-mirror-ai-avatar-option--active' : ''}`}
                  onClick={() => updateMirorLocal({ mirorAvatarProfile: option as AvatarOption })}
                >
                  <img
                    src={`/images/ai/miror_${option}.png`}
                    alt={option}
                    className="ft-mirror-ai-avatar-image"
                  />
                </button>
              ))}
            </div>
          ...
          {/* Live Preview */}
          <div className="ft-mirror-ai-preview-wrapper">
            <div className="ft-mirror-ai-preview-label">Live Preview</div>
            <div className="ft-mirror-ai-preview">
              <div className="ft-mirror-ai-preview-avatar-container">
                <img
                  src={`/images/ai/miror_${avatarProfile}.png`}
                  alt="Preview"
                  className="ft-mirror-ai-preview-avatar"
                />
                {mounted && enchantmentEnabled && showStar && (
                  <img
                    ...
                    alt=""
                    className="ft-mirror-ai-preview-twinkle"
                  />
                )}
              </div>
            </div>
          ...
          <div className="ft-mirror-ai-star-wrapper">
            ...
            <span className="ft-mirror-ai-star-label">On / Off</span>
          </div>
          ...
          <div className={`ft-enchant-radio-container ${enchantmentEnabled ? 'ft-enchant-radio-container--active' : ''}`}>
            <span className="ft-mirror-ai-enchantment-label">Enchantment Effect</span>
            <Input.radioFancy
