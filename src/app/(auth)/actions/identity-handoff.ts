...
export async function performIdentityHandoff(): Promise<IdentityHandoffResult> {
  ...
  try {
    ...
    // Handle avatarUrl which can be string or storage ID
    const avatarUrlString = typeof convexUser.avatarUrl === 'string' ? convexUser.avatarUrl : undefined;
    const brandLogoUrlString = typeof convexUser.brandLogoUrl === 'string' ? convexUser.brandLogoUrl : undefined;
