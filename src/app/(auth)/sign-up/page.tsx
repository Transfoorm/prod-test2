...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError("");
    setIsSubmitting(true); // FUSE: Optimistic - assume success
    ...
    try {
      ...
      if (signUpResult.status === "missing_requirements") {
        // For now, we'll skip email verification as per requirements
        // In production, you'd handle verification here
      }
      ...
      if (signUpResult.status === "complete") {
        ...
        if (signUpResult.createdSessionId) {
          ...
          // If no session created, redirect to sign-in
          router.push("/sign-in");
  ...
  return (
    <div className="auth-page">
      <div className="auth-container">
        {/* Logo */}
        <div className="auth-logo-wrapper-compact">
          { }
          <img
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="auth-field">
                ...
                <p className="auth-help-text">
                  Password must also include 1 uppercase, 1 number, and 1 symbol.
                </p>
              </div>
