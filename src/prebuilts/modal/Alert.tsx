  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <div className="vr-modal-alert-header">
          <div className="vr-modal-alert-header-content">
            {iconSVGs[variant]}
            <h2 id="alert-title" className="vr-modal-alert-title">
              {title}
            </h2>
          </div>
        </div>
        ...
        <div className="vr-modal-alert-content">
          <p className="vr-modal-alert-message">
            {message}
          </p>
          ...
          {details && details.length > 0 && (
            <div className="vr-modal-alert-details">
              <div className="vr-modal-alert-details-header">
                Details
              </div>
