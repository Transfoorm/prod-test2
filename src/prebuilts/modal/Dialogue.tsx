...
export default function DialogueModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="vr-modal-dialogue-header">
          <h2 id="vr-modal-dialogue-title" className="vr-modal-dialogue-title">{title}</h2>
          <button
        ...
        {actions.length > 0 && (
          <div className="vr-modal-dialogue-actions">
            {actions.map((action, index) => (
              <button
                key={index}
                className={`vr-modal-dialogue-vr-modal-dialogue-action-button vr-modal-dialogue-action-${action.variant || 'secondary'}`}
