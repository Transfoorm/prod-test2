  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="vr-modal-confirmation-header">
          <h2 id="vr-modal-confirmation-title" className="vr-modal-confirmation-title">{title}</h2>
        </div>

        {/* Message */}
        <p className="vr-modal-confirmation-message">{message}</p>
