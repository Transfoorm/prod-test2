...
export default function VerifyModal({
  ...
  // Spinner SVG
  const spinner = (
    <svg className="vr-modal-verify-spinner" viewBox="0 0 24 24" fill="none">
      <circle className="vr-modal-verify-spinner-circle" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
      <path className="vr-modal-verify-spinner-path" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
    </svg>
  );
  ...
  const successView = (
    <div className="vr-modal-verify-success">
      ...
      <h2 className="vr-modal-verify-heading">{successHeading}</h2>
      <p className="vr-modal-verify-description">{successDescription}</p>
      <div className="vr-modal-verify-progress">
        ...
        <p className="vr-modal-verify-progress-text">{successProgressText}</p>
      </div>
    </div>
  );
  ...
  const preparingView = (
    <div className="vr-modal-verify-preparing">
      <div className="vr-modal-verify-spinner vr-modal-verify-spinner--large">
        {spinner}
      </div>
      <p className="vr-modal-verify-preparing-text">{preparingText}</p>
    </div>
  );
  ...
  const codeInputView = (
    <div className="vr-modal-verify-form">
      <h2 className="vr-modal-verify-heading">{heading}</h2>
      <p className="vr-modal-verify-description">{description}</p>
      ...
      {/* Email confirmation */}
      <p className="vr-modal-verify-email-hint">
      ...
      {error && (
        <div className="vr-modal-verify-error">
          <p className="vr-modal-verify-error-text">{error}</p>
        </div>
      )}
